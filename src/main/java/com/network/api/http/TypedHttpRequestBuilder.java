...
/**
 * Specialized builder for HTTP requests that deserialize responses to a specific type.
 * 
 * <p>This interface extends {@link HttpRequestBuilder} to provide type-safe response handling.
 * 
 * @param <T> the type to deserialize responses to
 */
public interface TypedHttpRequestBuilder<T> {
     ...
     */
    TypedHttpRequestBuilder<T> method(HttpMethod method);
     ...
     */
    TypedHttpRequestBuilder<T> url(URL url);
     ...
     */
    TypedHttpRequestBuilder<T> uri(URI uri);
     ...
     */
    TypedHttpRequestBuilder<T> url(String url);
     ...
     */
    TypedHttpRequestBuilder<T> path(String path);
     ...
     */
    TypedHttpRequestBuilder<T> queryParam(String name, String value);
     ...
     */
    TypedHttpRequestBuilder<T> queryParams(Map<String, String> params);
     ...
     * @throws IllegalArgumentException if name is null
     */
    TypedHttpRequestBuilder<T> pathParam(String name, String value);
     ...
     * @throws IllegalArgumentException if params is null
     */
    TypedHttpRequestBuilder<T> pathParams(Map<String, String> params);
     ...
     * @throws IllegalArgumentException if name is null
     */
    TypedHttpRequestBuilder<T> header(String name, String value);
     ...
     */
    TypedHttpRequestBuilder<T> headers(Map<String, String> headers);
     ...
     */
    TypedHttpRequestBuilder<T> contentType(String contentType);
     ...
     */
    TypedHttpRequestBuilder<T> accept(String accept);
     ...
     * @return this builder
     */
    TypedHttpRequestBuilder<T> body(String body);
     ...
     * @return this builder
     */
    TypedHttpRequestBuilder<T> body(byte[] body);
     ...
     * @return this builder
     */
    TypedHttpRequestBuilder<T> body(Object body);
     ...
     * @throws IllegalArgumentException if params is null
     */
    TypedHttpRequestBuilder<T> formParams(Map<String, String> params);
     ...
     */
    TypedHttpRequestBuilder<T> serializer(Serializer serializer);
     ...
     * @return this builder
     */
    TypedHttpRequestBuilder<T> followRedirects(boolean followRedirects);
     ...
     */
    TypedHttpRequestBuilder<T> timeout(int timeoutMillis);
     ...
     */
    TypedHttpRequestBuilder<T> attribute(String key, Object value);
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> get() {
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> post() {
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> put() {
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> delete() {
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> patch() {
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> head() {
     ...
     * @return this builder
     */
    default TypedHttpRequestBuilder<T> options() {
     ...
     */
    HttpResponse<T> execute() throws NetworkException;
